...
**
** This is the .h file for Movie.h which contains the function defintions 
** for the functions outlined in the .cpp file. This implements the functions needed to make an instance of the Movie class. 
**
***********************************************/
