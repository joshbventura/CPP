...
**
** This is the .h file for MoviePlayer.h which contains the function definitions 
** for the functions outlined in the .cpp file. This defines the functions needed to make an instance of the MoviePlayer class. 
**
***********************************************/
